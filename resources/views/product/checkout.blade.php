                                ...
                                <form id="paymentForm" method="POST" action="{{ route('purchase') }}" class="card-form mt-3 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">                                
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="shippingAddress2">Address 2<span class="required-symbol">*</span></label>              
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mt-3 text-center">
                                            ...
                                            <a id="card-button" class="btn btn-dark pay">Place Order</a>
                                        </div>
                                    </div>                                    
                                </form>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $("#paymentForm").validate({
                ...
                messages: {
                    ...
                    shippingAddress2: "Address2 is required.",
